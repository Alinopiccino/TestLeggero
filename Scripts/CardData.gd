...
# 🔑 Identità runtime (NON esportata)
var runtime_uid: int = 0
...
@export_enum("None", "sacrificeAllyCreature","AllyCreature_Water_or_SpellCaster","FieldFlooded") var activation_cost: String = "None" # ✅ nuovo: costo di attivazione dell'effetto
...
@export_enum("None", "Overkill", "Taunt", "Lifesteal", "Charge", "Berserker", "Haste", "Assault", "Regeneration", "Stun", "Flying", "Double Strike", "Elusive", "Mastery", "Magic Veil", "Phys Immune", "Magical Taunt", "Reactivity", "Freeze", "Ruthless","Deathtouch","Free Strike") var talent_1: String = "None"
@export_enum("None", "Overkill", "Taunt", "Lifesteal", "Charge", "Berserker", "Haste", "Assault", "Regeneration", "Stun", "Flying", "Double Strike", "Elusive", "Mastery", "Magic Veil", "Phys Immune", "Magical Taunt", "Reactivity", "Freeze", "Ruthless","Deathtouch","Free Strike") var talent_2: String = "None"
@export_enum("None", "Overkill", "Taunt", "Lifesteal", "Charge", "Berserker", "Haste", "Assault", "Regeneration", "Stun", "Flying", "Double Strike", "Elusive", "Mastery", "Magic Veil", "Phys Immune", "Magical Taunt", "Reactivity", "Freeze", "Ruthless","Deathtouch","Free Strike") var talent_3: String = "None"
@export_enum("None", "Overkill", "Taunt", "Lifesteal", "Charge", "Berserker", "Haste", "Assault", "Regeneration", "Stun", "Flying", "Double Strike", "Elusive", "Mastery", "Magic Veil", "Phys Immune", "Magical Taunt", "Reactivity", "Freeze", "Ruthless","Deathtouch","Free Strike") var talent_4: String = "None"
...
@export_enum("None", "Custom", "Damage", "Heal", "PreventDamage", "Destroy", "Bouncer", "ChangePosition", "Draw", "Buff", "BuffAtk" , "BuffHp", "BuffArmour", "Debuff", "DebuffAtk", "DebuffHp", "Freeze", "Stun", "Root", "Counter", "SpawnToken", "BuffTalent", "BuffSpellPower", "BuffFireSpellPower", "BuffEarthSpellPower", "BuffWindSpellPower", "BuffWaterSpellPower", "AddColorlessMana", "AddFireMana", "AddEarthMana", "AddWindMana", "AddWaterMana","PayMana_for","FieldFlood","FieldBurn","FieldWindy","FieldArid","AddRepeats") var effect_1: String = "None"
@export_enum("None", "Custom", "Damage", "Heal", "PreventDamage", "Destroy", "Bouncer", "ChangePosition", "Draw", "Buff", "BuffAtk" , "BuffHp", "BuffArmour", "Debuff", "DebuffAtk", "DebuffHp", "Freeze", "Stun", "Root", "Counter", "SpawnToken", "BuffTalent", "BuffSpellPower", "BuffFireSpellPower", "BuffEarthSpellPower", "BuffWindSpellPower", "BuffWaterSpellPower", "AddColorlessMana", "AddFireMana", "AddEarthMana", "AddWindMana", "AddWaterMana","PayMana_for","FieldFlood","FieldBurn","FieldWindy","FieldArid","AddRepeats") var effect_2: String = "None"
@export_enum("None", "Custom", "Damage", "Heal", "PreventDamage", "Destroy", "Bouncer", "ChangePosition", "Draw", "Buff", "BuffAtk" , "BuffHp", "BuffArmour", "Debuff", "DebuffAtk", "DebuffHp", "Freeze", "Stun", "Root", "Counter", "SpawnToken", "BuffTalent", "BuffSpellPower", "BuffFireSpellPower", "BuffEarthSpellPower", "BuffWindSpellPower", "BuffWaterSpellPower", "AddColorlessMana", "AddFireMana", "AddEarthMana", "AddWindMana", "AddWaterMana","PayMana_for","FieldFlood","FieldBurn","FieldWindy","FieldArid","AddRepeats") var effect_3: String = "None"
@export_enum("None", "Custom", "Damage", "Heal", "PreventDamage", "Destroy", "Bouncer", "ChangePosition", "Draw", "Buff", "BuffAtk" , "BuffHp", "BuffArmour", "Debuff", "DebuffAtk", "DebuffHp", "Freeze", "Stun", "Root", "Counter", "SpawnToken", "BuffTalent", "BuffSpellPower", "BuffFireSpellPower", "BuffEarthSpellPower", "BuffWindSpellPower", "BuffWaterSpellPower", "AddColorlessMana", "AddFireMana", "AddEarthMana", "AddWindMana", "AddWaterMana","PayMana_for","FieldFlood","FieldBurn","FieldWindy","FieldArid","AddRepeats") var effect_4: String = "None"
@export_enum("None", "Custom", "Damage", "Heal", "PreventDamage", "Destroy", "Bouncer", "ChangePosition", "Draw", "Buff", "BuffAtk" , "BuffHp", "BuffArmour", "Debuff", "DebuffAtk", "DebuffHp", "Freeze", "Stun", "Root", "Counter", "SpawnToken", "BuffTalent", "BuffSpellPower", "BuffFireSpellPower", "BuffEarthSpellPower", "BuffWindSpellPower", "BuffWaterSpellPower", "AddColorlessMana", "AddFireMana", "AddEarthMana", "AddWindMana", "AddWaterMana","PayMana_for","FieldFlood","FieldBurn","FieldWindy","FieldArid","AddRepeats") var effect_5: String = "None"
...
@export_enum("None", "AllCreatures", "AllATKCreatures", "AllDEFCreatures", "AllFireCreatures", "AllEarthCreatures", "AllWaterCreatures", "AllWindCreatures", "AllEnemyCreatures", "AllEnemyATKCreatures", "AllEnemyDEFCreatures", "AllCards", "AllAllyCreatures", "AllAllyDEFCreatures", "AllAllyATKCreatures", "Self", "SelfPlayer", "EnemyPlayer", "BothPlayers","AllSpells", "AllEnemySpells","LastPlayedCreature","JustTargetedCreature", "AttackingCreature", "All_NON_WaterNON_Flying_Creatures","MyNextNormalSpell") var t_subtype_1: String = "None"
@export_enum("None", "AllCreatures", "AllATKCreatures", "AllDEFCreatures", "AllFireCreatures", "AllEarthCreatures", "AllWaterCreatures", "AllWindCreatures", "AllEnemyCreatures", "AllEnemyATKCreatures", "AllEnemyDEFCreatures", "AllCards", "AllAllyCreatures", "AllAllyDEFCreatures", "AllAllyATKCreatures", "Self", "SelfPlayer", "EnemyPlayer", "BothPlayers","AllSpells", "AllEnemySpells","LastPlayedCreature","JustTargetedCreature", "AttackingCreature", "All_NON_WaterNON_Flying_Creatures","MyNextNormalSpell") var t_subtype_2: String = "None"
@export_enum("None", "AllCreatures", "AllATKCreatures", "AllDEFCreatures", "AllFireCreatures", "AllEarthCreatures", "AllWaterCreatures", "AllWindCreatures", "AllEnemyCreatures", "AllEnemyATKCreatures", "AllEnemyDEFCreatures", "AllCards", "AllAllyCreatures", "AllAllyDEFCreatures", "AllAllyATKCreatures", "Self", "SelfPlayer", "EnemyPlayer", "BothPlayers","AllSpells", "AllEnemySpells","LastPlayedCreature","JustTargetedCreature", "AttackingCreature", "All_NON_WaterNON_Flying_Creatures","MyNextNormalSpell") var t_subtype_3: String = "None"
@export_enum("None", "AllCreatures", "AllATKCreatures", "AllDEFCreatures", "AllFireCreatures", "AllEarthCreatures", "AllWaterCreatures", "AllWindCreatures", "AllEnemyCreatures", "AllEnemyATKCreatures", "AllEnemyDEFCreatures", "AllCards", "AllAllyCreatures", "AllAllyDEFCreatures", "AllAllyATKCreatures", "Self", "SelfPlayer", "EnemyPlayer", "BothPlayers", "AllSpells", "AllEnemySpells","LastPlayedCreature" ,"JustTargetedCreature", "AttackingCreature", "All_NON_WaterNON_Flying_Creatures","MyNextNormalSpell") var t_subtype_4: String = "None"
@export_enum("None", "AllCreatures", "AllATKCreatures", "AllDEFCreatures", "AllFireCreatures", "AllEarthCreatures", "AllWaterCreatures", "AllWindCreatures", "AllEnemyCreatures", "AllEnemyATKCreatures", "AllEnemyDEFCreatures", "AllCards", "AllAllyCreatures", "AllAllyDEFCreatures", "AllAllyATKCreatures", "Self", "SelfPlayer", "EnemyPlayer", "BothPlayers", "AllSpells", "AllEnemySpells","LastPlayedCreature" ,"JustTargetedCreature", "AttackingCreature", "All_NON_WaterNON_Flying_Creatures","MyNextNormalSpell") var t_subtype_5: String = "None"
...
static func from_light_dict(data: Dictionary) -> CardData:
	var base := CardDatabase.get_card(data["tooltip"])
	if base == null:
		push_error("❌ Carta non trovata: " + data["tooltip"])
		return null

	var copy := base.make_runtime_copy()
	copy.card_name = data.get("card_name", "")
	return copy
